...
function q(u4, t3, i3, r3, o3, e3, f4, c3, s3) {
  var a3, h3, v3, y3, d3, _2, m3, b2 = i3.props || p, k3 = t3.props, x2 = t3.type;
  ...
  if (null == x2) b2 === k3 || c3 && u4.data == k3 || (u4.data = k3);
    ...
    if (e3 = e3 && n.call(u4.childNodes), !c3 && null != e3) for (b2 = {}, a3 = 0; a3 < u4.attributes.length; a3++) b2[(d3 = u4.attributes[a3]).name] = d3.value;
...
//# sourceMappingURL=chunk-2IKQZ7PD.js.map
