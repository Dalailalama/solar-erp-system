...
export default defineConfig(({ mode }) => {
    ...
    return {
        ...
        // Base public path: Use /static/dist/ in production to correctly map to Django's static output
        // In development, keep it as /static/ for HMR and dev server alignment
        ...
        server: {
            ...
            // Serve static files - use environment variable if present, else default
