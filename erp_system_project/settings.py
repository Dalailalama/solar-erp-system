...
MIDDLEWARE = [
    ...
    'erp_system_project.middleware.VideoUserIsolationMiddleware'
]
...
LOGIN_REQUIRED_IGNORE_PATHS = [
    ...
    r'^/video/login/',      # Dedicated video login
...
VITE_DEV_SERVER_HOST = env.str("VITE_DEV_SERVER_HOST", default="192.168.0.111")
